	...
	return (
		<div class="card lg:max-w-lg bg-base-100 shadow-xl">
			<div class="card-body mx-auto">
				...
				<label for="booking-modal" className="btn modal-button btn-secondary text-white uppercase bg-gradient-to-r from-secondary to-primary" disabled={slots.length===0} 
